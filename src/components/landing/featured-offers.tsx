        ...
        >
          <CarouselContent className="-ml-2">
            {filteredOffers.map((offer) => {
              ...
              return (
              <CarouselItem key={offer.id} className="pl-2 basis-4/5 sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5 flex">
                  <Card className={cn("overflow-hidden group transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1 w-full flex flex-col", offer.isHidden && "opacity-60")}>
