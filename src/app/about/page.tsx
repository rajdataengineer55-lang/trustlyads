      ...
      <main className="flex-1 bg-white dark:bg-gray-900/10 py-16 sm:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl font-headline font-bold mb-8">✨ About Us</h1>
            <div className="prose dark:prose-invert max-w-none space-y-6 text-lg">
              ...
              <h2 className="text-2xl font-headline font-bold mt-10 mb-4">🔹 What We Do</h2>
              ...
              <h2 className="text-2xl font-headline font-bold mt-10 mb-4">🔹 Our Values</h2>
              <ul className="list-disc list-inside space-y-2 pl-4">
