      ...
      <main className="flex-1 bg-background py-16 sm:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl sm:text-4xl font-headline font-bold mb-8">Terms of Service</h1>
            <div className="prose dark:prose-invert max-w-none space-y-6 text-base sm:text-lg">
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">1. Use of Service</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">2. User Accounts</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">3. Content</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">4. Limitation of Liability</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">5. Changes to Terms</h2>
