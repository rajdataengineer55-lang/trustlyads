        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose dark:prose-invert max-w-none space-y-6 text-base sm:text-lg">
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">2. How We Use Your Information</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">3. Security</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">4. Third-Party Services</h2>
              <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and practices of these sites, and cannot accept responsibility or liability for their respective privacy policies.</p>

              <h2 className="text-xl sm:text-2xl font-headline font-bold mt-10 mb-4">5. Your Rights</h2>
